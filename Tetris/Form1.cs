...
namespace Tetris
{
    public partial class Form1 : System.Windows.Forms.Form
    {
        ...
        SoundPlayer theme = new SoundPlayer();  // main tetris theme

        PictureBox[,] nextPiece = new PictureBox[4, 4]; // contains all nextPiece picture boxes from gamePanel
        PictureBox[,] board = new PictureBox[18, 10]; // contains all board picture boxes from gamePanel

        string[,] highScores = new string[10, 2];
        Label[,] highScoresLabels = new Label[10, 2]; // contains all highScores Labels from scoresPanel

        int timer2Time = 3; // a timer count down before actual game starts
        int n;  // used later, needs to be global so value doesn't get lost
        ...
        // basicly performs all necessary initializations before actual game starts
        public Form1()
        {
            InitializeComponent();
        ...
        // highlights buttons, labels when mouseovered
        ...
        // oposite action to above function, dehighlights if control is not any more mouseovered
        ...
        // performs action (checks if user is sure) when exit button in main menu is clicked
        ...
        // happens when yes label in confirmation panel is clicked, quits game
        private void sureYesLabel_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.Application.Exit();
        }

        // happens when no label in confirmation panel is clicked, doesn't quit game
        ...
        // displayes playMenuPanel when play button is clicked in main menu
        ...
        // goes back to main menu from play menu when back button in play menu is clicked
        ...
        // happenes when new game button in play menu is clicked, actually start new (everything zeroed out) game
        ...
        // loads saved game from json files
        ...
        // happenes when music button on bottom right is clicked, mutes music if not muted
        ...
        // happenes when sfx button on bottom right is clicked or M or CTRL+M is clicked, mutes sfx if not muted
        ...
        // happenes when resume label in pause menu is clicked, resumes paused game
        // if game ended then starts new game
        ...
        // happenes when quit and save label in pause menu is clicked, quites and saves game
        // if game ended then goes back to main menu without saving
        ...
        // happenes when pause button in bottom right is clicked or P or CTRL+P is pressed
        // pauses the game
        ...
        // displays scores panel when scores button in main menu is clicked
        ...
        // back button in scores menu, goes back to main menu when clicked
        ...
        // back button in help menu, goes back to main menu when clicked
        ...
        // displayes help panel when help button in main menu is clicked
        ...
        // stores all scores labels into a list for easier manipulation later
        ...
        // stores all board picture boxes into a list for easier manipulation later
        ...
        // reads Game.board and draws a board by changing BackColor of picture boxes from board array
        ...
        // does similar to above but with next piece on top right
        ...
        // checks if moving piece on board exists, adds new piece if not, also checks if game is over
        ...
        // moves piece one column down every timer tick
        ...
        // 3 seconds count down before the game
        ...
        // performs all the actions of button presses
